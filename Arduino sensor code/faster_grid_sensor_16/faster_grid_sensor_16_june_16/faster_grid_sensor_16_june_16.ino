...
const int ground=16; //define grid size (ground is digital-only side, power is analog-digital split side)
const int power=16;
...
int groundPinIDs[] = {g,g+1,g+2,g+3,g+4,g+5,g+6,g+7,g+8,g+9,g+10,g+11,g+12,g+13,g+14,g+15};
int powerPinIDs[] = {p,p+1,p+2,p+3,p+4,p+5,p+6,p+7,p+8,p+9,p+10,p+11,p+12,p+13,p+14,p+15};
//boolean valMode; // added June 16
//int pin;         // added June 16
...
void setPin(boolean valMode, int pin) {
  ...
  if (valMode) {
    DDRL = DDRL | B01000000;
    PORTL = PORTL | B01000000;
  }
  else {
    DDRL = DDRL & B10111111;
    PORTL = PORTL & B10111111;
  } 
  break;
