...
tic;
    ...
    %BLOCK 1%
    %fileName ='teeeest555555555.csv'
    %fileName ='P10-S716B-B1-constant.csv';
    %fileName ='P10-S716B-B1-scratch.csv';
    %fileName ='P10-S716B-B1-poke.csv';
    %fileName ='P10-S716B-B1-rub.csv';
    %fileName ='P10-S716B-B1-pinch.csv';
    %fileName ='P10-S716B-B1-slap.csv';
    %fileName ='P10-S716B-B1-pat.csv';
    %fileName ='P10-S716B-B1-tap.csv';
    %fileName ='P10-S716B-B1-tickle.csv';
    %fileName ='P10-S716B-B1-notouch.csv';
    %fileName ='P10-S716B-B1-stroke.csv';
    
   
    %BLOCK 2%   
    %fileName ='P10-S716B-B2-slap.csv';
    %fileName ='P10-S716B-B2-constant.csv';
    %fileName ='P10-S716B-B2-notouch.csv';
    %fileName ='P10-S716B-B2-tap.csv';
    %fileName ='P10-S716B-B2-pinch.csv';
    %fileName ='P10-S716B-B2-rub.csv';
    %fileName ='P10-S716B-B2-poke.csv';
    %fileName ='P10-S716B-B2-scratch.csv';
    %fileName ='P10-S716B-B2-tickle.csv';
    %fileName ='P10-S716B-B2-stroke.csv';
    %fileName ='P10-S716B-B2-pat.csv';
    %fileName ='111P10-S716B-B2-pat.csv';
