...
com = CreateSerialConnection('COM18',112500);

%InputBufferSize=100;
total_samples= 637; % the script reads this many samples and then stops. Was 637.
power=7; % # of powerpins on board
ground=5; % # of groundpins on board
