...
%InputBufferSize=100;
total_samples=331; % the script reads this many samples and then stops.
...
tic;
    ...
    %BLOCK 1%
    fileName = 'TEST222222-pat.csv';
    %fileName = 'P10-S1010-B1-pat.csv';
    %fileName = 'P10-S1010-B1-notouch.csv';
    %fileName = 'P10-S1010-B1-rub.csv';
    %fileName = 'P10-S1010-B1-tickle.csv';
    %fileName = 'P10-S1010-B1-pinch.csv';
    %fileName = 'P10-S1010-B1-tap.csv';
    %fileName = 'P10-S1010-B1-slap.csv';
    %fileName = 'P10-S1010-B1-stroke.csv';
    %fileName = 'P10-S1010-B1-scratch.csv';
    %fileName = 'P10-S1010-B1-poke.csv';
    %fileName = 'P10-S1010-B1-constant.csv';
    
    
    %BLOCK 2%
    %fileName = 'P10-S1010-B2-tickle.csv';
    %fileName = 'P10-S1010-B2-slap.csv';
    %fileName = 'P10-S1010-B2-rub.csv';
    %fileName = 'P10-S1010-B2-pinch.csv';
    %fileName = 'P10-S1010-B2-scratch.csv';
    %fileName = 'P10-S1010-B2-constant.csv';
    %fileName = 'P10-S1010-B2-stroke.csv';
    %fileName = 'P10-S1010-B2-tap.csv';
    %fileName = 'P10-S1010-B2-poke.csv';
    %fileName = 'P10-S1010-B2-notouch.csv';
    %fileName = 'P10-S1010-B2-pat.csv';
